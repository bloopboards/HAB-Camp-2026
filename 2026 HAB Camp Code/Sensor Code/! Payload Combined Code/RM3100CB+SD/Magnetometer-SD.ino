...
float gain;
double timeS = 0.0;
int columns = 5; //Number of Columns of Data, if you add more headers you MUST increase this value
const char* header[] = {"Time Elapsed (s),"," X component (uT),"," Y component (uT),"," Z component (uT),", " Magnitude(uT)" };
bool titles = true;
...
void loop() {
  ...
  double results[] = {timeS, xF, yF, zF, uT};
