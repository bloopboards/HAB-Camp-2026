...
void setup() {
  ...
  if (myFile) {
    ...
    myFile.println(F("Particles > 0.3um / 0.1L air, Particles > 0.5um / 0.1L air, Particles > 1.0um / 0.1L air, Particles > 2.5um / 0.1L air, Particles > 5.0um / 0.1L air, Particles > 10 um / 0.1L air"));
    myFile.close();
...
//Print to SD Card
 ...
 if (myFile) {
    ...
    myFile.println(data.particles_100um);   // use println for the last item to create a new row
